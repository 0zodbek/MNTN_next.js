    ...
    <div className="bg-black min-h-screen w-full relative">
      ...
      <div className="fixed right-8 top-1/2 -translate-y-1/2 z-50">
        <div className="flex flex-col items-center gap-8 relative">
          <div className="absolute w-px h-full bg-white/50 -z-10" />

          <a
            href="#start"
            className={`text-sm font-medium transition-colors ${
              activeSection === "start" ? "text-white" : "text-white/50"
            }`}
          >
            Start
          </a>
          ...
          {["01", "02", "03"].map((number) => (
            <a
              ...
              href={`#${number}`}
              className={`text-sm font-medium transition-colors ${
                activeSection === number ? "text-white" : "text-white/50"
              }`}
            >
              {number}
            </a>
      ...
      <section id="start" className="w-full  h-[1200px] relative">
        <div className="w-[1760px] h-[25px] top-[64px] flex justify-between z-50 left-20 absolute">
          ...
          <div className="w-72 flex justify-between">
            <a className="font-bold text-white text-lg cursor-pointer hover:text-yellow-500">
              Equipment
            </a>
            <a className="font-bold text-white text-lg cursor-pointer hover:text-yellow-500">
              About us
        ...
        <Image src="/HG.png" alt="Hero" layout="fill" objectFit="cover" />
        <Image
        ...
        <div className="absolute top-[464px]">
          ...
          <span className="flex transform rotate-90 font-bold text-white text-lg absolute top-0 left-8">
            Follow us{" "}
            <Image
              className="transform rotate-[-90deg] animate-bounce"
              src="/instagram.svg"
              alt="Instagram"
              width={20}
              height={20}
          ...
          <div className="w-[950px] absolute top-[-230px] ml-[500px]">
            <a className="text-[#FBD784] font-extrabold text-lg">
              ------- A Hiking guide
            </a>
            <h1
              className={`font-semibold my-8 text-white text-[80px] ${chronicleDisplay.className}`}
            >
              Be prepared for the Mountains and beyond!
            </h1>
            <div className="flex gap-2">
              <a className=" font-extrabold text-lg text-white">scroll down</a>
              <p className="animate-bounce font-extrabold text-lg text-white">
                ↓
              </p>
            </div>
          </div>
        ...
        <div className="absolute top-[768px] w-full">
      ...
      <section className="bg-[#0E1A2B]  text-white py-16 px-[239px]">
        <div
          id="01"
          className="flex md:flex-row items-center md:items-start mb-16 min-h-screen"
        >
          <div className=" z-50 md:w-1/2 text-center md:text-left">
          ...
          <div className="md:w-1/2 z-50 mt-8 md:mt-0">
            <Image
              src="/01.png"
              alt="Hiker Level"
        ...
        <div
          id="02"
          className="flex flex-col md:flex-row items-center md:items-start mb-16 min-h-screen"
        >
          ...
          <div className="md:w-1/2 text-center md:text-left md:pl-12 order-1 md:order-2">
            ...
            <p className="text-lg mt-4 leading-relaxed">
              ...
              really need any special gear. You can probably get away with
        ...
        <div
          id="03"
          className="flex flex-col md:flex-row items-center md:items-start mb-16 px-8 min-h-screen"
        >
